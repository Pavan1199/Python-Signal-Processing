...
ans, err = quad(integrand, -1000000000, -4)
x1=ans
def integrand(y):
    return -y-2

ans, err = quad(integrand, -4,-2)
x2=ans
def integrand(y):
    return 0
...
ans, err = quad(integrand, 1,3)
x5=ans
def integrand(y):
    return -2

ans, err = quad(integrand, 3,4)
x6=ans
def integrand(y):
    return y-6

ans, err = quad(integrand, 4,6)
x7=ans
def integrand(y):
    return 0

ans, err = quad(integrand, 6,1000000000)
x8=ans
...
ans, err = quad(integrand, 6,1000)
x8=ans

i=0
i=x1+x2+x3+x4+x5+x6+x7+x8

u=np.arange(-100,1000,1)

print("average power is nearly zero when taken from -100 to 1000 and its value is ",(i/len(u)))
